...
export const PRESETS = {
  ...
  easy: {
    ...
    courses: [
      ...
      { course_code: "MATH101", course_name: "Calculus I",       exam_duration_minutes: 120 },
      { course_code: "MATH102", course_name: "Calculus II",      exam_duration_minutes: 120 },
      { course_code: "MATH201", course_name: "Linear Algebra",   exam_duration_minutes: 120 },
      // Group B — Computer Science (indices 3-5)
      { course_code: "CS101",   course_name: "Intro to Programming", exam_duration_minutes: 120 },
      { course_code: "CS102",   course_name: "Data Structures",      exam_duration_minutes: 120 },
      { course_code: "CS201",   course_name: "Algorithms",           exam_duration_minutes: 120 },
      // Group C — Physics (indices 6-8)
      { course_code: "PHY101",  course_name: "Mechanics",            exam_duration_minutes: 120 },
      { course_code: "PHY102",  course_name: "Electromagnetism",     exam_duration_minutes: 120 },
      { course_code: "PHY201",  course_name: "Thermodynamics",       exam_duration_minutes: 120 },
      // Group D — Chemistry (indices 9-11)
      { course_code: "CHEM101", course_name: "General Chemistry I",  exam_duration_minutes: 120 },
      { course_code: "CHEM102", course_name: "General Chemistry II", exam_duration_minutes: 120 },
      { course_code: "CHEM201", course_name: "Organic Chemistry",    exam_duration_minutes: 120 },
      // Group E — History (indices 12-14)
      { course_code: "HIST101", course_name: "World History I",      exam_duration_minutes: 90 },
      { course_code: "HIST102", course_name: "World History II",     exam_duration_minutes: 90 },
      { course_code: "HIST201", course_name: "Modern History",       exam_duration_minutes: 90 },
    ],
  ...
  standard: {
    ...
    courses: [
      ...
      { course_code: "CE101", course_name: "Introduction to Engineering",  exam_duration_minutes: 120 },
      { course_code: "CE102", course_name: "Engineering Mathematics I",    exam_duration_minutes: 120 },
      { course_code: "CE103", course_name: "Physics for Engineers",        exam_duration_minutes: 120 },
      { course_code: "CE104", course_name: "Technical Drawing",            exam_duration_minutes:  90 },
      { course_code: "CE105", course_name: "Computer Fundamentals",        exam_duration_minutes: 120 },
      { course_code: "CE106", course_name: "Engineering Chemistry",        exam_duration_minutes: 120 },
      // Year 2 — Core (indices 6-11)
      { course_code: "CE201", course_name: "Engineering Mathematics II",   exam_duration_minutes: 120 },
      { course_code: "CE202", course_name: "Mechanics of Materials",       exam_duration_minutes: 120 },
      { course_code: "CE203", course_name: "Thermodynamics",               exam_duration_minutes: 120 },
      { course_code: "CE204", course_name: "Electrical Circuits",          exam_duration_minutes: 120 },
      { course_code: "CE205", course_name: "Programming for Engineers",    exam_duration_minutes: 120 },
      { course_code: "CE206", course_name: "Fluid Mechanics",              exam_duration_minutes: 120 },
      // Year 3 — Advanced (indices 12-17)
      { course_code: "CE301", course_name: "Control Systems",              exam_duration_minutes: 120 },
      { course_code: "CE302", course_name: "Signals and Systems",          exam_duration_minutes: 120 },
      { course_code: "CE303", course_name: "Digital Electronics",          exam_duration_minutes: 120 },
      { course_code: "CE304", course_name: "Engineering Statistics",       exam_duration_minutes: 120 },
      { course_code: "CE305", course_name: "Numerical Methods",            exam_duration_minutes: 120 },
      { course_code: "CE306", course_name: "Machine Learning Basics",      exam_duration_minutes: 120 },
      // Year 4 — Specialization (indices 18-23)
      { course_code: "CE401", course_name: "Advanced Algorithms",          exam_duration_minutes: 120 },
      { course_code: "CE402", course_name: "Computer Networks",            exam_duration_minutes: 120 },
      { course_code: "CE403", course_name: "Operating Systems",            exam_duration_minutes: 120 },
      { course_code: "CE404", course_name: "Database Systems",             exam_duration_minutes: 120 },
      { course_code: "CE405", course_name: "Software Engineering",         exam_duration_minutes: 120 },
      { course_code: "CE406", course_name: "Capstone Project",             exam_duration_minutes:  90 },
    ],
  ...
  stressed: {
    ...
    courses: [
      ...
      { course_code: "UNIV101", course_name: "Critical Thinking",               exam_duration_minutes: 120 },
      { course_code: "UNIV102", course_name: "Academic Communication",          exam_duration_minutes:  90 },
      { course_code: "UNIV103", course_name: "Research Methods",                exam_duration_minutes: 120 },
      { course_code: "UNIV104", course_name: "Ethics in Technology",            exam_duration_minutes:  90 },
      { course_code: "UNIV105", course_name: "Quantitative Reasoning",          exam_duration_minutes: 120 },
      { course_code: "UNIV106", course_name: "Digital Literacy",                exam_duration_minutes:  90 },
      { course_code: "UNIV107", course_name: "Environmental Science",           exam_duration_minutes: 120 },
      { course_code: "UNIV108", course_name: "Social Sciences",                 exam_duration_minutes:  90 },
      { course_code: "UNIV109", course_name: "Health and Wellness",             exam_duration_minutes:  90 },
      { course_code: "UNIV110", course_name: "Innovation and Entrepreneurship", exam_duration_minutes: 120 },
      { course_code: "UNIV111", course_name: "Global Perspectives",             exam_duration_minutes:  90 },
      // ── Dept A — Computer Science (indices 11-16) ──────────────────────
      { course_code: "CS301", course_name: "Software Architecture",        exam_duration_minutes: 120 },
      { course_code: "CS302", course_name: "Distributed Systems",          exam_duration_minutes: 120 },
      { course_code: "CS303", course_name: "Cloud Computing",              exam_duration_minutes: 120 },
      { course_code: "CS304", course_name: "Cybersecurity Fundamentals",   exam_duration_minutes: 120 },
      { course_code: "CS305", course_name: "Artificial Intelligence",      exam_duration_minutes: 120 },
      { course_code: "CS306", course_name: "Computer Vision",              exam_duration_minutes: 120 },
      // ── Dept B — Electrical Engineering (indices 17-22) ────────────────
      { course_code: "EE301", course_name: "Power Systems",                exam_duration_minutes: 120 },
      { course_code: "EE302", course_name: "Microelectronics",             exam_duration_minutes: 120 },
      { course_code: "EE303", course_name: "Signal Processing",            exam_duration_minutes: 120 },
      { course_code: "EE304", course_name: "Embedded Systems",             exam_duration_minutes: 120 },
      { course_code: "EE305", course_name: "Renewable Energy Systems",     exam_duration_minutes: 120 },
      { course_code: "EE306", course_name: "Control Engineering",          exam_duration_minutes: 120 },
      // ── Dept C — Mechanical Engineering (indices 23-28) ────────────────
      { course_code: "ME301", course_name: "Advanced Manufacturing",       exam_duration_minutes: 120 },
      { course_code: "ME302", course_name: "Robotics",                     exam_duration_minutes: 120 },
      { course_code: "ME303", course_name: "Computational Mechanics",      exam_duration_minutes: 120 },
      { course_code: "ME304", course_name: "Heat Transfer",                exam_duration_minutes: 120 },
      { course_code: "ME305", course_name: "Vibrations",                   exam_duration_minutes: 120 },
      { course_code: "ME306", course_name: "Materials Science",            exam_duration_minutes: 120 },
      // ── Dept D — Civil Engineering (indices 29-34) ─────────────────────
      { course_code: "CIVIL301", course_name: "Structural Analysis",       exam_duration_minutes: 120 },
      { course_code: "CIVIL302", course_name: "Geotechnical Engineering",  exam_duration_minutes: 120 },
      { course_code: "CIVIL303", course_name: "Transportation Engineering",exam_duration_minutes: 120 },
      { course_code: "CIVIL304", course_name: "Construction Management",   exam_duration_minutes: 120 },
      { course_code: "CIVIL305", course_name: "Water Resources",           exam_duration_minutes: 120 },
      { course_code: "CIVIL306", course_name: "Environmental Engineering", exam_duration_minutes: 120 },
    ],
